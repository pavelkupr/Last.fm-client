...
class CustomTabBarController: UITabBarController {
    ...
    private func createController2() -> UIViewController {
        let controller = ViewControllerForStorableData.getInstanceFromStoryboard()
        controller.setData(viewsInfo: [TableViewInfo(data: [], navName: "Favorite Artists",
                                                     dataSource: dataService.getFavoriteArtistsClosure()),
                                       TableViewInfo(data: [], navName: "Favorite Tracks",
                                                     dataSource: dataService.getFavoriteTracksClosure())],
                                       header: "Favorites")
